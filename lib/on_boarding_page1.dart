...
import 'package:proyek_akhir_dicoding/on_boarding_page2.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        ...
        children: [
          // image
          Image.asset('images/run_image1.png'),
          const SizedBox(
            height: 20,
          ),
          // description
          ...
          ElevatedButton(onPressed: (){
            Navigator.pushReplacement(context, MaterialPageRoute(builder:(context) => OnBoardingPage2(),));
          }, child: Text('Continue')),
          const SizedBox(
            height: 25,
          )
